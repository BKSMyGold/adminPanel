...
const GBPLevels = () => {
  const [gbplevels, setGBPLevels] = useState([]);
  useEffect(() => {
    const fetchgbplevels = async () => {
      const { data } = await axios.get(`${BASE_URL}/api/level`);
                    ...
                    <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                      ...
                      <thead>
                        <tr class="fw-bolder text-muted">
                          ...
                          <th class="min-w-140px">Level Name</th>
