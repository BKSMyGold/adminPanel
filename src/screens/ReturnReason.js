...
import { getReturnReason, deleteReturnReason } from "../APIs_Hai/ReturnReason";
  ...
  return (
    <div className="d-flex flex-column flex-root">
      <div className="page d-flex flex-row flex-column-fluid">
        ...
        >
          <Header />
          <Dashboard createLink={"/master/return_reason/add"} />
          <div
              ...
              <div class="card mb-5 mb-xl-8">
                <div class="card-header border-0 pt-5">
                  <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">Return Reason</span>
                    ...
                    <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                      <thead>
                        <tr class="fw-bolder text-muted text-center">
                          ...
                          <th class="min-w-140px">Return Reason</th>
