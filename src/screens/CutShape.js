  ...
  return (
    <div className="d-flex flex-column flex-root">
      <div className="page d-flex flex-row flex-column-fluid">
        ...
        >
          <Header />
          <Dashboard createLink={"/master/product-data/cut-shape/add"} />
          <div
                    ...
                    <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                      ...
                      <thead>
                        <tr class="fw-bolder text-muted text-center">
                          ...
                          <th class="fw-bolder text-muted">Cut Id</th>
                          <th class="fw-bolder text-muted">Cut Name</th>
                        ...
                        {cutShape.map((cut) => (
                          <tr class="text-center">
                            ...
                            <td class="text-center">
                              <Link
                                to={"/master/product-data/cut-shape/edit"}
                                state={cut}
                              >
