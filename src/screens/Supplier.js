...
import { getSupplier,deleteSupplier } from "../APIs_Hai/Supplier";
//=====================================================
const Supplier = (props) => {
  ...
  useEffect(() => {
    ...
    getSupplier().then((res) => {
      return setSupplier(res.data.data.data), setLoader(false);
    });
  }, []);
  ...
  return (
    <div className="d-flex flex-column flex-root">
      <div className="page d-flex flex-row flex-column-fluid">
        ...
        >
          <Header />
          <Dashboard createLink={"/master/supplier/add"} />
          <div
                    ...
                    <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3">
                      <thead>
                        <tr class="fw-bolder text-muted text-center">
                          ...
                          <th class="min-w-150px">Supplier ID</th>
