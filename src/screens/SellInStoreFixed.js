...
const SellInStoreFixed = () => {
  const [sellInStoreFixed, setSellInStoreFixed] = useState([])
  useEffect(() => {
    const fetchcategories = async () => {
      const { data: response } = await axios.get('http://13.59.57.74:5000/api/appointment')

      setSellInStoreFixed(response.data.filter(appointment => appointment.status === 'Offer Accepted'))
      // setSellInStoreFixed(response.data) // Uncomment this to get all the data
    }
    fetchcategories()
  }, [])
  return (
                ...
                <div class='card-body py-3'>
                  ...
                  <div class='table-responsive'>
                    ...
                    <table class='table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3'>
                      ...
                      {/*begin::Table body*/}
                      <tbody>
                        {sellInStoreFixed.map((appointment) => (
                          <tr>
                            <td>
                              {appointment.id}
                            </td>
...
export default SellInStoreFixed
