...
const SellVerifierCustomerAllotment = () => {
            const [categories,setSellVerifierCustomerAllotment] = useState([])
            useEffect(()=>{
                 const fetchcategories = async()=>{
                     const {data} = await axios.get('http://13.59.57.74:5000/api/Category')
                     
                     setSellVerifierCustomerAllotment(data)
                 }
                 fetchcategories()
            },[])  
        return ( 
							...
							<div class="card mb-5 mb-xl-8">
								...
								<div class="card-header border-0 pt-5">
									<h3 class="card-title align-items-start flex-column">
										<span class="card-label fw-bolder fs-3 mb-1">SellVerifierCustomerAllotment</span>
										<span class="text-muted mt-1 fw-bold fs-7">Define SellVerifierCustomerAllotment</span>
									</h3>
...
export default SellVerifierCustomerAllotment