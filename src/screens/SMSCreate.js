...
const SMSCreate = () => {
            const [categories,setSMSCreate] = useState([])
            useEffect(()=>{
							...
							<div class="card mb-5 mb-xl-8">
								...
								<div class="card-header border-0 pt-5">
									<h3 class="card-title align-items-start flex-column">
										<span class="card-label fw-bolder fs-3 mb-1">SMSCreate</span>
										<span class="text-muted mt-1 fw-bold fs-7">Define SMSCreate</span>
									</h3>
