...
const AccumalatedGoldSummaryInPlan = () => {
  const [categories, setAccumalatedGoldSummaryInPlan] = useState([]);
  useEffect(() => {
    const fetchcategories = async () => {
      const { data } = await axios.get(`${BASE_URL}/api/Category`);

      setAccumalatedGoldSummaryInPlan(data);
    };
    fetchcategories();
  }, []);
  return (
                ...
                <div class="card-header border-0 pt-5">
                  <h3 class="card-title align-items-start flex-column">
                    ...
                    <span class="text-muted mt-1 fw-bold fs-7">
                      Define AccumalatedGoldSummaryInPlan
                    </span>
                  </h3>
...
export default AccumalatedGoldSummaryInPlan;
