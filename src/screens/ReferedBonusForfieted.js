...
const ReferedBonusForfieted = () => {
            const [categories,setReferedBonusForfieted] = useState([])
            useEffect(()=>{
                 const fetchcategories = async()=>{
                     const {data} = await axios.get('http://13.59.57.74:5000/api/Category')
                     
                     setReferedBonusForfieted(data)
                 }
                 fetchcategories()
            },[])  
        return ( 
							...
							<div class="card mb-5 mb-xl-8">
								...
								<div class="card-header border-0 pt-5">
									<h3 class="card-title align-items-start flex-column">
										<span class="card-label fw-bolder fs-3 mb-1">ReferedBonusForfieted</span>
										<span class="text-muted mt-1 fw-bold fs-7">Define ReferedBonusForfieted</span>
									</h3>
...
export default ReferedBonusForfieted