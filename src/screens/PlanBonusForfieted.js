...
const PlanBonusForfieted = () => {
  ...
  useEffect(() => {
    const fetchSubscriptions = async () => {
      ...
      setSubscriptions(data.subscriptions.filter(subscription => subscription.status === 'Forfieted'))
    }
    fetchSubscriptions()
                          ...
                          <tr>
                            ...
                            <td>
                              <a
                                ...
                                class='text-dark fw-bolder text-hover-primary d-block mb-1 fs-6'
                              >
                                {subscription.plan !== null ? subscription.plan.cyclePeriod.name : subscription.customPlan.cyclePeriod[0].name}
                              </a>
                            </td>
                            <td class='text-dark fw-bolder text-hover-primary fs-6'>
                              {subscription.plan !== null ? "Standard Plan" : "Flexi Plan"}
                            </td>
                            <td>
                              <span class='badge badge-light-success'>
                                {subscription.plan !== null ? subscription.plan.mode : subscription.customPlan.mode}
                              </span>
                            </td>
                            <td>
                              <span class='badge badge-light-success'>
                            ...
                            <td>
                              {subscriptionsByUser[subscription.user.id] * planBonusCalculation} GRAM
                            </td>
...
export default PlanBonusForfieted
