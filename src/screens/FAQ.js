...
import { deleteFAQ, getFAQ } from "../APIs_Hai/FAQ";
...
const FAQ = (props) => {
  ...
  useEffect(() => {
    setLoader(true);
    getFAQ().then((res) => {
      return setFaq(res.data.data.data), setLoader(false);
    });
  }, []);
  ...
  return (
    <div className="d-flex flex-column flex-root">
      <div className="page d-flex flex-row flex-column-fluid">
        ...
        >
          <Header />
          <Dashboard createLink={"/master/faq/add"} />
          <div
                          ...
                          faq.map((faq) => (
                            <tr class="text-center">
                              ...
                              <td class="text-center">
                                <Link to={"/master/faq/edit"} state={faq}>
