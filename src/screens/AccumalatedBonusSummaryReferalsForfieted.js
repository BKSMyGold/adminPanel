...
const AccumalatedBonusSummaryReferalsForfieted = () => {
  const [categories, setAccumalatedBonusSummaryReferalsForfieted] = useState(
    []
  );
  useEffect(() => {
    const fetchcategories = async () => {
      ...
      setAccumalatedBonusSummaryReferalsForfieted(data);
    };
    fetchcategories();
  }, []);
  return (
                ...
                <div class="card-header border-0 pt-5">
                  <h3 class="card-title align-items-start flex-column">
                    ...
                    <span class="text-muted mt-1 fw-bold fs-7">
                      Define AccumalatedBonusSummaryReferalsForfieted
                    </span>
                  </h3>
...
export default AccumalatedBonusSummaryReferalsForfieted;
