...
const SellCustomerQuery = () => {
  const [categories, setSellCustomerQuery] = useState([])
  useEffect(() => {
    const fetchcategories = async () => {
      const { data } = await axios.get('http://13.59.57.74:5000/api/Category')

      setSellCustomerQuery(data)
    }
    fetchcategories()
  }, [])
  return (
...
export default SellCustomerQuery
