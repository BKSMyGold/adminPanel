...
const AccumalatedBonusSummaryPlansDue = () => {
  const [categories, setAccumalatedBonusSummaryPlansDue] = useState([]);
  useEffect(() => {
    const fetchcategories = async () => {
      const { data } = await axios.get(`${BASE_URL}/api/Category`);

      setAccumalatedBonusSummaryPlansDue(data);
    };
    fetchcategories();
  }, []);
  return (
                ...
                <div class="card-header border-0 pt-5">
                  <h3 class="card-title align-items-start flex-column">
                    ...
                    <span class="text-muted mt-1 fw-bold fs-7">
                      Define AccumalatedBonusSummaryPlansDue
                    </span>
                  </h3>
...
export default AccumalatedBonusSummaryPlansDue;
