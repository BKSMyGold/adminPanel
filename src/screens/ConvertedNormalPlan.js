...
const ConvertedNormalPlan = () => {
  ...
  useEffect(() => {
    const fetchSubscriptions = async () => {
      ...
      setSubscriptions(data.subscriptions.filter(subscription => !subscription.customPlan && subscription.status === 'Forfieted'))
...
export default ConvertedNormalPlan
