...
import { getCertificate, deleteCertificate} from "../APIs_Hai/Certificate";
...
const Certificate = (props) => {
  ...
  useEffect(() => {
    ...
    getCertificate().then((res) => {
      return setCertificate(res.data.data.data), setLoader(false);
    });
  }, []);
  ...
  return (
    <div className="d-flex flex-column flex-root">
      <div className="page d-flex flex-row flex-column-fluid">
        ...
        >
          <Header />
          <Dashboard createLink={"/master/certificates/add"} />
          <div
