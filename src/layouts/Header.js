              ...
              >
                ...
                >
                  ...
                  <div  style={{zIndex:100}} className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-rounded-0 py-lg-4 w-lg-225px">
                      ...
                      <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                        ...
                        >
                          ...
                          <div className="menu-item">
                            <a
                              className="menu-link py-3"
                              href="/master/product-data/product-type"
                            >
                              <span className="menu-bullet">
                                <span className="bullet bullet-dot"></span>
                              </span>
                              <span className="menu-title">Product Type</span>
                            </a>
                          </div>
                          <div className="menu-item">
                            <a
                    ...
                    <div className="menu-item">
                      <a
                        className="menu-link py-3"
                        href="/master/loan_intrest_rates"
                      >
                        <span className="menu-icon">
                          {/*begin::Svg Icon | path: /icons/duotune/general/gen002.svg*/}
                          <span className="svg-icon svg-icon-2">
                    ...
                    <div className="menu-item">
                      ...
                      >
                        ...
                        <span className="menu-title">Referral Type </span>
                      </a>
                    </div>
                    ...
                    >
                      ...
                      <div className="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg py-lg-4 w-lg-225px">
                        ...
                        <div className="menu-item">
                          <a
                            className="menu-link py-3"
                            href="/reports/instant_gold_report"
                          >
                            <span className="menu-bullet">
                              <span className="bullet bullet-dot"></span>
                            </span>
                        ...
                        <div className="menu-item">
                          <a
                            className="menu-link py-3"
                            href="/reports/sell_and_reserve_report"
                          >
                            <span className="menu-bullet">
                              <span className="bullet bullet-dot"></span>
                            </span>
                            <span className="menu-title">
                              Sell and Reserve Report
                            </span>
                          </a>
                        </div>
                      </div>
                ...
                <Link to="/register">
                  <span className="menu-link  register">
                    ...
                    >
                      <span className="menu-title">Register a System User</span>
                    </div>
                  </span>
                </Link>
                <Link to="/add_user">
                  <span className="menu-link  register">
                    <div
                      ...
                      className="menu-item py-5 ms-4"
                    >
                      <span className="menu-title">Add A User</span>
                    </div>
                  </span>
                </Link>
              </div>
