          ...
          children: item.children
            .map((item1) => {
              if (item1.children) {
                return {
                  ...item1,
                  children: item1.children?.filter((e) => perms.has(e.value)),
                };
              } else if (perms.has(item1.value)) {
                return {
                  ...item1,
                };
              } else {
...
function RoleRight(props) {
  ...
  let perma = new Set(props?.user?.role?.permissions);
  console.log(perma);
  //========================================
  useEffect(() => {
    setNode(getAllowedNodes(perma));
  }, []);
  //========================================
  ...
  return (
    <>
      ...
      <button class="btn btn-warning m-5" onClick={() => console.log(state.permissions)}>
        Add Role Rights{" "}
      </button>
      <Footer />
    </>
