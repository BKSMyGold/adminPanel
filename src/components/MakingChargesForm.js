                    ...
                    <form>
                      ...
                      <div>
                        ...
                        >
                          ...
                          {varieties.map((x) => {
                            return (
                              <option class="form-control" value={x.varietyName}>
                                {x.varietyName}
                              </option>
                            );
                          })}
                      ...
                      <div>
                        ...
                        >
                          ...
                          {items.map((x) => {
                            return (
                              <option class="form-control" value={x.itemName}>
                                {x.itemName}
                              </option>
                            );
                          })}
                      ...
                      <div>
                        ...
                        <input
                          type="number"
                          name="valueOfRateType"
                          className="form-control form-control-lg form-control-solid"
                          placeholder="Enter the value of Rate Type"
                          onChange={(e) =>
                            setMakingCharges({
                              ...makingCharges,
                              valueOfRateType: e.target.value,
                            })
                          }
                            value={makingCharges.valueOfRateType}                          
                        />
                      </div>
