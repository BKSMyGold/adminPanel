...
const PlanBonus = (props) => {
  ...
  function putCharges(planBonus){
      return(
          axios.put(`${BASE_URL}/api/calculation/${planBonus.id}`, {...planBonus})
      )
  }
                ...
                <div class="card-header border-0 pt-5">
                  <h3 class="card-title align-items-start flex-column">
                    <span class="card-label fw-bolder fs-3 mb-1">
                      {isUpdate ? "Update Charges" : "Add Charges"}
                    </span>
                  ...
                  <div class="table-responsive">
                    <form>
                      ...
                      <AddUpdateSpinner
                        ...
                        collection={planBonus}
                        adding={addMetalGroup}
                        updating={putCharges}
                        url={"/master/plans/plan-bonus/"}
                      />
                    </form>
                  </div>
                  {/*end::Table container*/}
